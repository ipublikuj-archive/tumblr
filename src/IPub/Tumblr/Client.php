...
class Client extends ApiCall
{
	...
	/**
	 * The ID of the Tumblr user, or 0 if the user is logged out
	 *
	 * @var integer
	 */
	private $user;
	...
	/**
	 * Get the UID of the connected user, or 0 if the Tumblr user is not connected.
	 *
	 ...
	 *
	 * @return integer The id of the connected Tumblr user, or 0 if no such user exists
	 */
	...
	/**
	 * Get a request token from Tumblr
	 *
	 ...
	 * (previously generated from www.tumblr.com on behalf of a specific user).
	 * The authorization verifier and token is sent to www.tumblr.com/oauth
	 * and a legitimate access token is generated provided the access token
	 * and the user for which it was generated all match, and the user is
	 * either logged in to Tumblr or has granted an offline access permission
	 *
